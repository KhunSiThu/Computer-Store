import { cart_products,fav_products } from "./main.js";
    ...
    if(menu_con.classList.contains("dis_none"))
        {
            ...
            menu_con.classList.remove("dis_bl");
...
const product_show = (e1,e2) => {
    e1.innerHTML +=  `
                        <div class="product_box b3 col_black" num = "${e2.id}">
                            <div class = "save">
